...
const SurveyRequest = () => {
  ...
  //       formik.setFieldValue("targetPopulation", data);
  //     });
  ...
  //     [name]: checked,
  //   }));
  //   // Clear "Other (Specify)" when unchecked
  ...
  // Validation states
  // const [officialLetterError, setOfficialLetterError] = useState("");
  // const [studyObjectiveError, setStudyObjectiveError] = useState("");

  // const validateFile = (file) => {
  //   if (!file) return "This file is required";
  //   if (!allowedFormats.includes(file.type))
  //     return "Sorry! The file format must be .pdf, .docx, .xlsx or image";
  //   return "";
  // };

  // const handleOfficialLetterChange = (e) => {
  //   const file = e.target.files[0];
  //   const errorMsg = validateFile(file);
  //   setOfficialLetterError(errorMsg);
  //   if (!errorMsg) {
  //     setOfficialLetterFile(file);
  //   } else {
  //     setOfficialLetterFile(null);
  //   }
  // };

  // const handleStudyObjectiveChange = (e) => {
  //   const file = e.target.files[0];
  //   const errorMsg = file
  //     ? allowedFormats.includes(file.type)
  //       ? ""
  //       : "Sorry! The file format must be .pdf, .docx, .xlsx or image"
  //     : "";
  //   setStudyObjectiveError(errorMsg);
  //   if (!errorMsg) {
  //     setStudyObjectiveFile(file);
  //   } else {
  //     setStudyObjectiveFile(null);
  //   }
  // };

  // const clearOfficialLetter = () => {
  //   setOfficialLetterFile(null);
  //   setOfficialLetterError("");
  //   // To clear file input programmatically, use a ref (not shown here)
  // };

  // const clearStudyObjective = () => {
  //   setStudyObjectiveFile(null);
  //   setStudyObjectiveError("");
  //   // To clear file input programmatically, use a ref (not shown here)
  // };
  ...
  //   // Add your form validation and submit logic here
  // };
  ...
  const handleExportPDF = () => {
    ...
    // Implement your export PDF logic here
  };
  ...
  return (
    <section className="contact-section" style={{ backgroundColor: "#ffffff" }}>
      ...
      <div ref={formRef} className="container survey-req-container py-10">
        <form
