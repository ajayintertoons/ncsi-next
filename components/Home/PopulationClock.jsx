...
const PopulationClock = ({ populationData }) => {
  ...
  const populationList = populationData?.populations || [];
  ...
  const [selectedDate, setSelectedDate] = useState(() => {
    const latest = populationList?.[populationList.length - 1];
  ...
  const monthName = selectedDate.toLocaleDateString("en-GB", { month: "short" });
  ...
  return (
    <div className="row population-clock-main-row">
      <div className="col">
        <div className="population-clock-header bg-theme color-white text-bold">
          <div className="row align-items-center">
            ...
            <div className="col-10 ps-0">
              <a href="#" className="clock-head text-decoration-none ">
        ...
        <div className="population-clock-content bg-white" style={{ height: "568px", padding: "15px 0px" }}>
          <OdoMeter value={total.toLocaleString()} />

          <div className="row text-center padding-15">
            <div id="hdTotalPopulation" className="col text-25 text-bold">
              {t("total_population")}
            </div>
          </div>
          ...
          <div className="PopulationBL" id="PopulationBL">
            <span className="Dpop">{selectedDate.toLocaleDateString("en-GB")}</span>
              ...
              <div className="date-select" style={{ width: "100%" }}>
                <div className="popup flex justify-around">
                  ...
                  <div className="flex-1 flex flex-col gap-1 day border-none">
                    <a href="" onClick={(e) => { e.preventDefault(); changeDate("day", 1) }} className="btn-arrow btn-up">
                  ...
                  <div className="flex-1 flex flex-col gap-1 month">
                    <a href="" onClick={(e) => { e.preventDefault(); changeDate("month", 1) }} className="btn-arrow btn-up">
                      <i className="fas fa-caret-up"></i>
                    </a>
                    <div>
                  ...
                  <div className="flex-1 flex flex-col gap-1 year">
                    <a href="" onClick={(e) => { e.preventDefault(); changeDate("year", 1)}} className="btn-arrow btn-up">
                      <i className="fas fa-caret-up"></i>
                    </a>
                    <span className="num">{year}</span>
                    <a href="" onClick={(e) => { e.preventDefault(); changeDate("year", -1)}} className="btn-arrow btn-down">
                      <i className="fas fa-caret-down"></i>
                    </a>
                  </div>
                </div>
