...
const ContactCeoModal = ({ isOpen, onClose }) => {
  ...
  const [captchaValue, setCaptchaValue] = useState(""); // State to store the CAPTCHA image value
                    ...
                    <div className="form-group">
                      ...
                      <div className="col-sm-8">
                        ...
                        {/* <img
                          ...
                          onClick={(e) =>
                            (e.target.src = `/api/generate-captcha?reload=${Date.now()}`)
                          }
                        /> */}
                        <input
                          type="text"
