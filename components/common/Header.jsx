   ...
   <div className="container custom-container text-center" >
          <div className="row header-row">
            ...
            <div className="col-sm-12 col-md-8 col-lg-6 align-self-center header-row-col header-row-col-middle">
               <div className="header-row-col-middle-sub">
                  <div className="row">
                     ...
                     <div className="col col-6 middle-col-small-device">
                        <div className="header-middle-buttons" id="contact-ceo">
                           <div className="row wow fadeInLeft" onClick={onOpenModal} data-wow-delay="0.4s" data-wow-duration="0.5s">
                              <div className="col-sm-4 header-middle-buttons-first-col text-center">
                                  {t('contact')}
                              </div>
                  ...
                  <div className="row margin-top-on-small-screen">
                     <div className="col col-6 middle-col-small-device">
                        <div className="header-middle-buttons">
                           <div className="row wow fadeInLeft" data-wow-delay="0.6s" data-wow-duration="0.5s">
                              <div className="col-sm-4 header-middle-buttons-first-col text-center">
                                  {t('search')}
                              </div>
